...
GLFWwindow* init(const GLuint w, const GLuint h) {
    ...
    GLFWwindow *win = glfwCreateWindow(w, h, "Light casters", nullptr, nullptr);
    if (win == nullptr)
    ...
    switch (option) {
        ...
        case 1:
            draw_objects(win, vertices,
                    ...
                    shad_path + "light_shader_attenuate_01.frag"}, option,
                    true);
            break;
        case 0:
        default:
            draw_objects(win, vertices,
                    Shader {shad_path + "light_shader_direct_01.vs",
                    shad_path + "light_shader_direct_01.frag"}, option);
    }
}
